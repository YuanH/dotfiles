# Clear oh-my-zsh git-plugin aliases that collide with the function/alias
# names defined below (gcd, gri, grm). Without this, zsh errors out with
# "defining function based on alias" when sourcing this file.
unalias gcd gri grm 2>/dev/null
